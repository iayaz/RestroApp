...
export class AppComponent {
  ...
  showData: any[] = [...this.menu];
  handleData(filter: string) {
    console.log('worked');
    this.showData = [...this.menu];
    if (filter === 'mains') {
      this.showData = this.showData.filter((val) => val.category === 'mains');
    } else if (filter === 'starters') {
      this.showData = this.showData.filter(
        (val) => val.category === 'starters'
      );
    } else if (filter === 'desserts') {
      this.showData = this.showData.filter(
        (val) => val.category === 'desserts'
      );
    } else if (filter === 'beverages') {
      this.showData = this.showData.filter(
        (val) => val.category === 'beverages'
      );
    }
  }
}
